...
def main():
    ...
    joint_states = array.array('f', [0.0, -1.5707, 1.5707, -1.5707, -1.5707, 0.0])
    ...
    node.get_logger().info(f"Moving to {{joint_positions: {list(joint_states)}}}")
